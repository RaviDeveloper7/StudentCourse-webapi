...
namespace StudentCourseAPI.Migrations
{
    ...
    [Migration("20250910102958_passwordHashedAgain")]
    partial class passwordHashedAgain
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StudentCourseAPI.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Department = "products",
                            Email = "xyz@gmail.com",
                            Password = "AQAAAAIAAYagAAAAEEGU5LGhxIgv1XM9f/PP79pGckARS5P8/qxmEhFlgqJQMwA+EpKX4+X5P9bNgmheAw==",
                            Role = "admin",
                            Username = "admin"
                        });
                });
